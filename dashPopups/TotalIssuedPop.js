...
const TotalIssuedPop = ({ setShowTotalIssuedPop }) => {
    ...
    const handleSort = () => {
        ...
        const sortedData = issuedPdcData.slice().sort((a, b) => {
        ...
        sortedData && setIssuedPdcData(sortedData)
    }
        ...
        <View style={styles.modalContainer}>
            ...
            <View style={styles.modalContent}>
                ...
                <View style={{
                    ...
                    <Text style={{ fontSize: 18 }}>Issued PDC</Text>
                    <TouchableOpacity style={{ backgroundColor: 'red', borderRadius: 4 }} onPress={() => setShowTotalIssuedPop(false)}>
                ...
                <ScrollView>
                    <ScrollView horizontal={true}>
                        <View style={styles.TableContainer}>
                            ...
                            {
                                issuedPdcData && issuedPdcData.map((item, id) => (
                                    <View style={styles.tableRow} key={id}>
                                        ...
                                        <Text style={styles.dataCell}>{item.Supplier}</Text>
                                    </View>
                                ))
                            }
                            {/* 
