...
const BankBalancePop = ({ setShowBankBalancePop, bankBalanceList }) => {


    // console.log('bankBalanceListFromBankPop', bankBalanceList)
    return (
        <View style={styles.modalContainer}>
            ...
            <View style={styles.modalContent}>
                ...
                <View style={{
                    ...
                    <TouchableOpacity style={{ backgroundColor: 'red', borderRadius: 4 }} onPress={() => setShowBankBalancePop(false)}>
                        <Text style={{ color: 'white', fontSize: 18, paddingHorizontal: 8, paddingVertical: 4 }}>Close</Text>
                    </TouchableOpacity>
                </View>

                {/* <View style={{ maxHeight: 450, minHeight:'auto' }}> */}
                <ScrollView>
                    <ScrollView horizontal={true}>
                        <View style={styles.TableContainer}>
                            ...
                            {
                                bankBalanceList && bankBalanceList.length > 0 && bankBalanceList.map((item, index) => (
