...
const TotalSalesTablePop = ({ setTotalSalesTablePop, salesData }) => {
        ...
        <View style={styles.modalContainer}>
            ...
            <View style={styles.modalContent}>
                ...
                <View style={{
                    ...
                    <Text style={{ fontSize: 18 }}>Sales Data</Text>
                    <TouchableOpacity style={{ backgroundColor: 'red', borderRadius: 4 }} onPress={() => setTotalSalesTablePop(false)}>
                    ...
                    <ScrollView horizontal={true}>
                        <View style={styles.TableContainer}>
                            <View style={styles.tableRow}>
                                <Text style={styles.headerCell}>Dept. No</Text>
                                <Text style={styles.headerCell}>Dept. Name</Text>
                                <Text style={styles.headerCell}>Sales</Text>
                            </View>

                            {
                                salesData && salesData.length > 0 && salesData.map((item, index) => (
...
export default TotalSalesTablePop