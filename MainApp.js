  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen
          name="MachineValidation"
          component={MachineValidation}
        ...
        />
        <Stack.Screen
          name="PickingListDetails"
          component={PickingListDetailPage}
          options={{headerShown: false}}
        />
        ...
        <Stack.Screen
          name="PickListNew"
          component={PickListNew}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="MyPickingList"
          component={MyPickList}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="CheckingListNew"
        ...
        <Stack.Screen
          name="GoodsCollectionDelivery"
          component={GoodsCollectionDelivery}
          options={{headerShown: false}}
        />

        <Stack.Screen
          name="WarehouseListItemDetails"
          component={WarehouseListItemDetails}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="GoodsCollectionDeliveryPoolList"
          component={GoodsCollectionDeliveryPoolList}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="WarehouseList"
        ...
        />
        <Stack.Screen
          name="WarehousePoolList"
          component={WarehousePoolList}
          options={{headerShown: false}}
        />
        ...
        />
        <Stack.Screen
          name="InspectionMaintenanceReport"
          component={InspectionMaintenanceReport}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="ScopeAndBOQ"
          component={ScopeAndBOQ}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="PhysicalStock"
        ...
        <Stack.Screen
          name="BarcodeLinking"
          component={BarcodeLinking}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="InvoiceVsReceipt"
          component={InvoiceVsReceipt}
          options={{headerShown: false}}
        />
        <Stack.Screen
          name="SalesReturn"
