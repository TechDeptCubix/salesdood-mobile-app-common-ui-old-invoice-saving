...
<head>
    ...
    const transformData1 = (data, customer, orderRemark, payment, delivery, validity, totalUnitPrice, cashCustomerName, cashCustomerAddress, cashCustomerPhone) => {
    ...
    const transformDataInvN = (data, customer, orderRemark, payment, delivery, validity, totalUnitPrice, cashCustomerName, cashCustomerAddress, cashCustomerPhone, trn) => {
        return data.map((item, index) => ({
            cmpcode: cmpcode,
            modeop: "SAVE",
            ...
            client_pd: "",
            tel: "",
            custref: customer ? customer.Custname : cashCustomerName ? cashCustomerName : '',
            terms: payment,
            deptno: deptNo ? deptNo : '',
            // deptno: 'HO',
            month: "",
            ...
            starter: customer ? customer.phone.trim() : cashCustomerPhone ? cashCustomerPhone : '',
                ...
                <View style={styles.modalContent}>
...

                    {
                        ...
                        <View style={styles.UpdateWrap}>
                            ...
                            {
                                page === 'SALESINV' ?
                                    <TouchableOpacity style={styles.EditButton} onPress={() => makeInvoice()}>
                                        <Text style={styles.EditText}>Send</Text>
                                    </TouchableOpacity>
                                    :
                                    <TouchableOpacity style={styles.EditButton} onPress={() => makeOrder()}>
                                        <Text style={styles.EditText}>Send</Text>
                                    </TouchableOpacity>
                            }
                        </View>
