...
const StatementPop = ({ setShowStatementPop, privateKey, accountNo, appUrl, cmpcode, setSelectedStock, selectedStock }) => {
...
`;
    ...
    const fetchStatementData = async () => {
        setShowLoader(true)
        console.log(`${appUrl}Statement/${cmpcode}/STMT_ACC1/${accountNo}/-/${fromData}/${toData}`)
        try {
            const result = await axios.get(`${appUrl}Statement/${cmpcode}/STMT_ACC1/${accountNo}/-/${fromData}/${toData}`)
                ...
                <View style={styles.FromToDateButtonWrap}>
                    ...
                    <View style={styles.DateButtonWrap}>
                        <TouchableOpacity style={styles.DetailsButton} onPress={showToDatePicker}>
                            <Text style={styles.DetailsText}>ToDate</Text>
                        </TouchableOpacity>
