...
const SalesInvoice = ({route}) => {
  ...
  const searchCustomer = async value => {
    ...
    console.log(
      'searchCustomer',
      `${appUrl}Search_Customer/${cmpcode}/Cust/${value}`,
    );
    try {
      await axios
        .get(`${appUrl}Search_Customer/${cmpcode}/Cust/${value}`)
        .then(res => {
          if (userAccess && userAccess.includes('-NE')) {
            ...
            setCustomerData(filteredArrayBasedOnSalesman);
            console.log(
  ...
  const searchStock = async value => {
    ...
    try {
      ...
      await axios
        .get(`${appUrl}Search_Items/${cmpcode}/Sitem/${value}`)
        .then(res => {
                  ...
                  <View style={styles.CustomerSearchInp}>
                    <View style={styles.InputImageCont}>
                      <Image
                        ...
                        source={require('../images/orangeLens.png')}
                      />
                    </View>
                    <TextInput
                    ...
                    <TouchableOpacity
                      style={styles.WalkInCutomerButton}
                      onPress={() => setShowCashCust(!showCashCust)}>
                      <Image
                        style={[styles.SearchIcon, {resizeMode: 'contain'}]}
                        source={require('../images/walkCustLight.png')}
                      />
                    </TouchableOpacity>
                  </View>
                </View>
                    ...
                    <View style={styles.CustomerUIWrap}>
                      <View style={styles.TabCont}>
                        <TouchableOpacity
                          style={[
                            styles.TabButtons,
                            selectedTab === 'Customer' && styles.SelectedTab,
                          ]}
                          onPress={() => setSelectedTab('Customer')}>
                          <Text
                            style={[
                              styles.TabText,
                              selectedTab === 'Customer' && styles.SelectedText,
                            ]}>
                            Customer
                          </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                          style={[
                            styles.TabButtons,
                            {marginLeft: 8},
                            selectedTab === 'Details' && styles.SelectedTab,
                          ]}
                          onPress={() => setSelectedTab('Details')}>
                          <Text
                            style={[
                              styles.TabText,
                              selectedTab === 'Details' && styles.SelectedText,
                            ]}>
                            Details
                          </Text>
                        </TouchableOpacity>
                      ...
                      {selectedTab === 'Customer' && (
                        <View style={[styles.CustUiItem, {paddingBottom: 16}]}>
                          ...
                          <Text style={styles.CustHeadTextValue}>
                            {selectedCustomer &&
                    ...
                    <View style={styles.CustomerUIWrap}>
                      <View style={styles.TabCont}>
                        <TouchableOpacity
                          ...
                          onPress={() => setWalkSelectTab('WalkCustomer')}>
                          <Text
                            style={[
                              styles.TabText,
                              walkSelectTab === 'WalkCustomer' &&
                        ...
                        <TouchableOpacity
                          style={[
                            styles.TabButtons,
                            {marginLeft: 8},
                            walkSelectTab === 'Details' && styles.SelectedTab,
                          ]}
                          onPress={() => setWalkSelectTab('Details')}>
                          <Text
                            style={[
                              styles.TabText,
                        ...
                        <View
                          ...
                          <TouchableOpacity
                            onPress={() => saveCashCustomerDetails()}
                            style={{
                              padding: 6,
                ...
                <View style={styles.StockItemWrap}>
                  <View style={styles.StockItemHead}>
                    ...
                    <View style={styles.StockBagWrap}>
                      <TouchableOpacity
                        style={styles.stockBagCont}
                        onPress={() =>
                          setShowSelectedStockPop(!showSelectedStockPop)
                        }>
                        <Image
                          style={styles.stockBagIcon}
                          source={require('../images/goCart.png')}
                        />
                        <Text style={styles.stockBagText}>Cart</Text>

                        <View style={styles.itemCount}>
                          <Text style={styles.itemCountText}>
                            {savedItemData && savedItemData.length}
                          </Text>
                        </View>
                      </TouchableOpacity>
                        ...
                        {stockData &&
                          ...
                          stockData.map((item, index) => (
                            <TouchableOpacity
                              ...
                              <Text style={styles.StockdataCell}>
                                {item.Code}
                              </Text>
                              <Text style={styles.StockdataCell}>
                                {item.Description}
