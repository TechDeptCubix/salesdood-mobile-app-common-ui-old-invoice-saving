import { View, Text, StyleSheet, ScrollView, Dimensions, FlatList, TouchableOpacity, TextInput, KeyboardAvoidingView, Alert, Image, ActivityIndicator, Pressable, Modal } from 'react-native'
...
const WarehousePoolList = ({ fetchMyPickListLength, showAcceptDetailsPopItem }) => {
                                ...
                                <View style={{ flexDirection: "row", justifyContent: "space-between", backgroundColor: "#ffffff", paddingBottom: 10, paddingHorizontal: 10 }}>
                                    ...
                                    <View style={[styles.BottomButtonCont, { backgroundColor: "#ffffff", width: "100%", alignItems: "center", justifyContent: "space-between" }]}>
                                        ...
                                        <View style={{ flexDirection: "row", alignItems: "baseline" }}>
                                            ...
                                            <TouchableOpacity style={styles.DetailsButton} onPress={() => navigation.navigate("WarehouseListItemDetails", {
                                                listItem: item
                                            })}>
...

                                            {
                                                ...
                                                <View style={{ flexDirection: "row" }}>
                                                    ...
                                                    <TouchableOpacity style={[styles.RejectButton, { backgroundColor: "#FFFFC5", marginLeft: 10 }]} onPress={() => { changeTaskStatusCommmonMethod(item, "BINNED") }}>
                                                        <Text style={{ color: "#000000" }}>Binned</Text>
                                                    </TouchableOpacity>

                                                   
                                                    <TouchableOpacity style={[styles.RejectButton, { backgroundColor: "#FFFFC5", marginLeft: 10 }]} onPress={() => { changeTaskStatusCommmonMethod(item, "PACKED") }}>
                                                        <Text style={{ color: "#000000" }}>Packed</Text>
                                                    </TouchableOpacity>
                                                </View>
                                            }
...
const styles = StyleSheet.create({
    ...
    modalView: {
        width: '80%',
        maxHeight: '60%', // Limit the height of the popup itself
        backgroundColor: 'white',
        borderRadius: 10,
        padding: 15,
        alignItems: 'center',
...
export default WarehousePoolList