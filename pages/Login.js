...
import { SafeAreaView, StyleSheet, View, TextInput, TouchableOpacity, Text, Image, KeyboardAvoidingView, ActivityIndicator, ImageBackground, Dimensions, ScrollView } from 'react-native'
                ...
                >
                    ...
                    >
                        ...
                        <View style={styles.SalesManImgWrap}>
                            <Image style={styles.SalesManImg} source={require('../images/salesDoodN.png')}></Image>
                    ...
                    <View style={styles.CmpSwtchWrap}>
                        {
                            ...
                            <View style={styles.ContinueWrap}>
                                ...
                                <TouchableOpacity style={[styles.button, { backgroundColor: 'white', marginLeft: 4, marginTop: 0, padding: 0, width: 'auto' }]} onPress={() => navigation.navigate('Home')}>
