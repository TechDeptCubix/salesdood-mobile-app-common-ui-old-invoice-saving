...
import InvoiceReceiptPopup from '../popups/InvoiceReceiptPopup'
import AsyncStorage from '@react-native-async-storage/async-storage'
import OutstandingPop from '../popups/OutstandingPop'


const InvoiceVsReceipt = () => {
    ...
    const [showInvoicePop, setShowInvoicePop] = useState(false)
    ...
    const viewInvoiceClick = (item) => {
        setSelectedStock(item)

        setShowInvoicePop(true)
    }
    ...
    return (
        <>
            <View style={styles.HomeWrap}>
                ...
                <HeaderUiNew name={'Invoice Vs Receipt'} />
                                                ...
                                                <View style={styles.StockListItem} key={index}>
                                                    ...
                                                    <View style={styles.CustomerListCont}>
                                                        ...
                                                        <View style={styles.CustomerListMid}>
                                                            ...
                                                            <TouchableOpacity style={[styles.QtyCont, { backgroundColor: '#D8D8DA', marginRight: 16 }]} onPress={() => viewInvoiceClick(item)}>
                                                                <Text style={styles.QtyText}>View</Text>
                                                            </TouchableOpacity>
                                                        </View>
            ...
            {
                showInvoicePop &&
                <InvoiceReceiptPopup setShowInvoicePop={setShowInvoicePop} privateKey={privateKey} accountNo={accountNo} appUrl={appUrl} cmpcode={cmpcode} setSelectedStock={setSelectedStock} selectedStock={selectedStock} />
            }
        </>
    )
}
