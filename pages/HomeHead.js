...
const HomeHead = () => {
    ...
    // console.log('salesMan', salesMan && salesMan)
    // console.log('salesRole', salesRole && salesRole)
            ...
            <View style={styles.HeadWrap}>
                ...
                <View style={{
                    ...
                    <View style={{ padding: 8 }}>
                        <Text style={{ fontSize: 18, color: 'white', fontFamily: 'Lexend-Bold' }}>{salesMan && salesMan}</Text>
                    </View>
