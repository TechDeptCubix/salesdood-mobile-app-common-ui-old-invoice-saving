import { View, Text, StyleSheet, Dimensions, Image, TouchableOpacity, TextInput, ScrollView, ActivityIndicator, FlatList, KeyboardAvoidingView, Keyboard } from 'react-native'
...
const CheckStock = () => {
    ...
    const fetchModalNumberData = async (OEM) => {
        ...
        try {
            ...
            console.log(`fetchModalNumberData--${appUrl}MasterList/${cmpcode}/MODELNUMBER/${encodedOem}`)
            const response = await axios.get(`${appUrl}MasterList/${cmpcode}/MODELNUMBER/${encodedOem}`)
    ...
    const fetchSubstituteData = async (Code) => {
        ...
        try {
            ...
            console.log(`fetchSubstituteData--${appUrl}MasterList/${cmpcode}/SUBSTITUTE/${encodedCode}`)
            const response = await axios.get(`${appUrl}MasterList/${cmpcode}/SUBSTITUTE/${encodedCode}`);
                                    ...
                                    <View style={styles.StockListItem} key={index}>
                                        ...
                                        <View style={styles.CustomerListCont}>
                                            ...
                                            <View style={styles.CustomerImgWrap}>
                                                <Image style={styles.CustomerImage} source={require('../images/stockList.png')} />
                                            </View>
                                                ...
                                                <View style={styles.DynamicPriceView}>
                                                    ...
                                                    <View style={styles.TabCont}>
                                                        <TouchableOpacity
                                                            style={[
                                                                ...
                                                                selectedButton === 'Substitute' && styles.SelectedButton
                                                            ]}
                                                            onPress={() => handlePress('Substitute')}
                                                        >
                                                            <Text style={[styles.StockListCodeText, { color: 'black' }]}>Substitute</Text>
                                                        </TouchableOpacity>
                                                        <TouchableOpacity
                                                            style={[
                                                                styles.ActionButtons,
                                                                selectedButton === 'Model' && styles.SelectedButton
                                                            ]}
                                                            onPress={() => handlePress('Model')}
                                                        >
                                                            <Text style={[styles.StockListCodeText, { color: 'black' }]}>Model Number</Text>
                                                        </TouchableOpacity>
                                                    </View>

                                                    {
                                                        ...
                                                        <View style={styles.TableContainer}>
                                                            ...
                                                            <ScrollView style={[styles.ScrollView, { minHeight: 'auto', maxHeight: 200 }]} nestedScrollEnabled={true}>

                                                                {
                                                                    substituteData && substituteData.length > 0 && substituteData.map((item, index) => (

                                                                        (
                                                                            <>
                                                                                <View style={styles.tableRow} key={index}>
                                                                                    <Text style={[styles.dataCell, { fontFamily: 'Lexend-Light', width: '50%' }]}>{item.Part_No}</Text>
                                                                                    <Text style={[styles.dataCell, { fontFamily: 'Lexend-Light', width: '20%', }]}>{item.Balance}</Text>
                                                                                    <Text style={[styles.dataCell, { fontFamily: 'Lexend-Light', width: '30%' }]}>{formatPrice3Decimal(item['Sales price'])}</Text>
                                                                                </View>
...

                                                                {
                                                                    ...
                                                                    <View style={styles.tableRow} key={index}>
                                                                        <Text style={[styles.dataCell, { fontFamily: 'Lexend-Light', width: '100%', color: 'red' }]}>No Data Available</Text>
...

                                                    {
                                                        ...
                                                        <View style={styles.TableContainer}>
                                                            ...
                                                            <ScrollView style={[styles.ScrollView, { minHeight: 'auto', maxHeight: 200 }]} nestedScrollEnabled={true}>
                                                                ...
                                                                {
                                                                    modalNumberData && modalNumberData.length > 0 && modalNumberData.map((item, index) => (

                                                                        (
                                                                            <>
                                                                                <View style={[styles.tableRow, { justifyContent: 'center' }]} key={index}>
                                                                                    <Text style={[styles.dataCell, { fontFamily: 'Lexend-Light', width: '100%', textAlign: 'middle' }]}>{item.Model_Number}</Text>
                                                                                </View>
                                                                ...
                                                                {
                                                                    modalNumberData && modalNumberData.length === 0 &&
                                                                    <View style={styles.tableRow} key={index}>
                                                                        <Text style={[styles.dataCell, { fontFamily: 'Lexend-Light', width: '100%', color: 'red' }]}>No Data Available</Text>
                        ...
                        <ScrollView contentContainerStyle={styles.MainScroll}>
                            <View style={styles.StockDescWrap}>
                                ...
                                <View style={styles.StockItem}>
                                    ...
                                    <Text style={styles.StockTextValue}>{selectedStock.Code}</Text>
                                </View>
                                <View style={styles.StockItem}>
                                    <Text style={styles.StockLabel}>Description</Text>
                                    <Text style={styles.StockTextValue}>{selectedStock.Description}</Text>
                                </View>
                                <View style={styles.StockItem}>
                                    <Text style={styles.StockLabel}>Price</Text>
                                    <Text style={styles.StockTextValue}>{selectedStock.price}</Text>
                                </View>
                                {/* <View style={styles.StockItem}>
                                ...
                                <View style={styles.StockItem}>
                                    ...
                                    <Text style={styles.StockTextValue}>{selectedStock.AvlQty}</Text>
                                </View>
                                <View style={styles.StockItem}>
                                    <Text style={styles.StockLabel}>Vehicle</Text>
                                    <Text style={styles.StockTextValue}>{selectedStock.Vehicle}</Text>
                                </View>
                                <View style={styles.StockItem}>
                                    <Text style={styles.StockLabel}>Brand</Text>
                                    <Text style={styles.StockTextValue}>{selectedStock.Brand}</Text>
                                </View>
                                <View style={styles.StockItem}>
                                    <Text style={styles.StockLabel}>Category</Text>
                                    <Text style={styles.StockTextValue}>{selectedStock.Category}</Text>
                                </View>
                                <View style={styles.StockItem}>
                                    <Text style={styles.StockLabel}>Sub Category</Text>
                                    <Text style={styles.StockTextValue}>{selectedStock['Sub Category']}</Text>
                                </View>
                            </View>

                            <View style={styles.TabWrap}>
                                <TouchableOpacity
                                    style={[styles.tab, selectedTab === 'MODAL' && styles.selectedTab]}
                                    onPress={() => setSelectedTab('MODAL')}
                                >
                                    <Text style={styles.tabText}>Model Number</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={[styles.tab, selectedTab === 'SUBSTITUTE' && styles.selectedTab]}
                            ...
                            <View style={styles.content}>
                                {selectedTab === 'MODAL' ? (
                                    ...
                                    <>
                                        ...
                                        {
                                            modalNumberData && modalNumberData.length === 0 && !modalLoader &&
                                            <View>
                                                <Text style={{
                                                    color: 'red', fontFamily: 'Lexend-Regular',
                                                    fontSize: 16
                                                }}>No data available</Text>
                                            </View>
                                        }
                                        ...
                                        <View style={styles.ModalCont}>
                                            <ScrollView nestedScrollEnabled={true} style={{ width: '100%', maxHeight: 300, marginBottom: 24 }}>
                                                {
                                                    modalNumberData && modalNumberData.length > 0 && modalNumberData.map((item, index) => (
                                                        <View style={styles.ModaltableRow} key={index}>
                                                            <Text style={styles.ModalDatacell}>{item.Model_Number}</Text>
                                                            {/* <Text style={styles.dataCell}>{item.Description}</Text> */}
                                                        </View>
                                    ...
                                    <View style={{
                                        ...
                                        <>
                                            ...
                                            {
                                                substituteData && substituteData.length === 0 && !subLoader &&
                                                <View>
                                                    <Text style={{
                                                        color: 'red', fontFamily: 'Lexend-Regular',
                                                        fontSize: 16
