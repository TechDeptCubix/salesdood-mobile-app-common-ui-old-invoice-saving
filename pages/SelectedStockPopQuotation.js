...
import PopHeadsQuotation from './PopHeadsQuotation'

const SelectedStockPopQuotation = ({
    savedItemData,
        ...
        <View style={styles.modalContainer}>
            <View style={styles.modalContent}>
                ...
                <View style={styles.HomeWrap}>
                    <PopHeadsQuotation setShowSelectedStockPop={setShowSelectedStockPop} showSelectedStockPop={showSelectedStockPop} setShowQuotationPop={setShowQuotationPop} page={page} />
...
export default SelectedStockPopQuotation