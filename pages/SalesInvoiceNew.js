    ...
    useEffect(() => {
        ...
        if (selectedCustomer) {
            ...
            if (selectedCustomer.CREDITMETHOD == 'CREDIT BLOCK' && selectedRadio === 'CREDIT') {
                ...
                if (selectedCustomer.Avai_Bal < selectedCustomer.Credit_Limit && selectedCustomer.Avai_Bal !== 0) {
                    setCustomerCreditBlocked(false)
                    setCustomerSearchItem('')
...

                                            {
                                                ...
                                                <>
                                                    ...
                                                    <ScrollView nestedScrollEnabled={true} contentContainerStyle={[styles.CheckStockListView]} keyboardShouldPersistTaps="handled">
                                                        ...
                                                        {
                                                            stockData && stockData.length > 0 && stockData.map((item, index) => (
                                                                <TouchableOpacity style={[styles.StockListItem, { borderColor: 'grey', borderWidth: 0.5 }]} key={index} onPress={() => setSelectedStock(item)}>
                                                                    <View style={styles.CustomerListCont}>
