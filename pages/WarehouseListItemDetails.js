...
const WarehouseListItemDetails = ({ }) => {
    ...
    return (
        <ScrollView style={styles.StockCountWrap}>
            ...
            <View style={styles.HeadCont}>
                <Text style={styles.TaskListHeadText}>Store - Goods Receive and Dispatch</Text>
            </View>
            ...
            <View style={styles.TaskDetailMidInpCont}>
                ...
                <View style={[styles.TaskViewBox, {
                    ...
                    <Text style={styles.label}>Supplier Inv.# </Text>
                    <TextInput keyboardType="numeric" style={styles.input} onChangeText={(text) => handleInput(text, "supplier_inv")} value={userTypedValues.supplier_inv} />
                </View>

                <View style={[styles.TaskViewBox, {
                    width: "100%"
                }]}>
                    <Text style={styles.label}>Supplier DO.# </Text>
                    <TextInput keyboardType="numeric" style={styles.input} onChangeText={(text) => handleInput(text, "supplier_do")} value={userTypedValues.supplier_do} />
                </View>
...

            {
                ...
                <View style={[styles.buttonRow,
                    ...
                    <TouchableOpacity style={[styles.TaskCompleteButton, { width: '40%' }]}
                        onPress={() => save_delivery_items_last_step("BINNED")}
                    // disabled={updateLoader}
                    >
                        <Text style={{ color: "#ffffff", fontSize: 16 }}>BINNED</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={[styles.TaskCompleteButton, { width: '40%', marginLeft: 10 }]}
                        onPress={() => save_delivery_items_last_step("PACKED")}
                    // disabled={updateLoader}
                    >
                        <Text style={{ color: "#ffffff", fontSize: 16 }}>PACKED</Text>
                    </TouchableOpacity>
...
export default WarehouseListItemDetails