...
const MyPickingList = ({ fetchMyPickListLength, showAcceptDetailsPopItem }) => {
    ...
    return (
        ...
        //     <HeaderUiNew name={'My Picking List'} />
                    ...
                    <ScrollView horizontal={true} style={{ width: '100%', minHeight: 'auto', maxHeight: Dimensions.get('window').height - 85 }}>
                        ...
                        <View style={styles.CollTableContainer}>
                            ...
                            <View style={styles.ColltableRow}>
                                ...
                                <Text style={styles.CollheaderCell}>Pick_Qty</Text>
                                                    ...
                                                    switchValues[item.Code] ? (
                                                        ...
                                                        <View style={styles.inputContainer}>
                                                            <TextInput
                                                                ...
                                                                onChangeText={(text) => handleInputChange(item.Code, item.SO_Qty, text)}
                                                                placeholder="Enter qty"
                                                                keyboardType="numeric" // Restricts input to numeric keypad
                                                            />
                                                        </View>
                                                    )
                                                }
                                                ...
                                                <View style={[styles.ColldataCell, { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: 160 }]}>
                                                    <RadioGroup
                                                        ...
                                                        onPress={(radioButtonsArray) => {
                                                            ...
                                                            handleSwitchChange(item.Code, radioButtonsArray, item.SO_Qty);
                                                        }}
