import { View, Text, StyleSheet, Dimensions, Image, TouchableOpacity, TextInput, ScrollView, ActivityIndicator, KeyboardAvoidingView, Platform } from 'react-native'
...
const MakeOrder = ({ route }) => {

    const { orderId, type } = route.params || {};

    const navigation = useNavigation()

    const customerSearchUrl = `https://cubixweberp.com:208/api/Search_Customer/automax/Cust/`
            ...
            <View style={styles.HomeWrap}>
                ...
                <KeyboardAvoidingView
                    ...
                    <View style={{ width: '100%', height: '100%' }}>
                        <ScrollView contentContainerStyle={styles.MainScroll} bounces={false}>

                            {
                                ...
                                <>
                                    <View style={{
                                        ...
                                        <TouchableOpacity style={styles.WalkInputCont} onPress={() => setShowCashCust(!showCashCust)}>
                                            <View style={styles.InputImageCont}>
                                                <Image style={styles.SearchIcon} source={require('../images/walk.png')} />
                                            </View>
                                            {
                                                !showCashCust ?
                                                    <Text style={styles.TextInput}>Walk-in customer</Text> :
                                                    <Text style={styles.TextInput}>Remove Walk-in customer</Text>
                                            }
                                            ...
                                            <View style={styles.CustomerUIWrap}>
...

                                                {
                                                    ...
                                                    <>
                                                        ...
                                                        <View style={styles.CustUiItem}>
                                                            <Text style={styles.CustHeadText}>Balance</Text>
                                                            <Text style={styles.CustHeadTextValue}>{selectedCustomer && selectedCustomer.openbal !== '' ? selectedCustomer.openbal : ''}</Text>
                                                        </View>
                                                        <View style={styles.CustUiItem}>
                                        ...
                                        <>
                                            ...
                                            <View style={styles.CustomerUIWrap}>
                                                ...
                                                <View style={{
                                                    ...
                                                    <Text style={styles.CustomerText}>Walk in Customer</Text>
                                                </View>
                                                ...
                                                <View style={{
                                                    ...
                                                    {
                                                        showDetails ?
                                                            <TouchableOpacity style={styles.UPDOWNButton} onPress={() => setShowDetails(!showDetails)}>
                                                                <Image style={styles.UPDOWNIMG} source={require('../images/upIcon.png')} />
                                                            </TouchableOpacity>
                                                            :
                                                            <TouchableOpacity style={styles.UPDOWNButton} onPress={() => setShowDetails(!showDetails)}>
                                                                <Image style={styles.UPDOWNIMG} source={require('../images/downIcon.png')} />
                                                            </TouchableOpacity>
                                                    }
                                                ...
                                                {
                                                    showDetails &&
                                                    <View style={styles.CustomerUIWrapDrop}>
                                                        <View style={styles.RemarkInputCont}>
                                                            <TextInput
                                                                style={styles.PlaceHolderInput}
                                                                placeholder='Enter order remark'
