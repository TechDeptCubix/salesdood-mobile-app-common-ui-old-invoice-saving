...
const PopHeadsQuotation = ({ setShowSelectedStockPop, showSelectedStockPop, setShowQuotationPop, page }) => {
        ...
        <View style={styles.HeadWrap}>
            ...
            <View>
                <TouchableOpacity style={styles.SettingsWrap} onPress={() => setShowQuotationPop(true)}>
                            ...
                            <Text style={styles.ShowQuotText}>Quotation</Text>
...
export default PopHeadsQuotation