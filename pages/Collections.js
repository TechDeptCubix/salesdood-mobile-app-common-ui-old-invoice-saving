import { View, Text, StyleSheet, Dimensions, Image, TouchableOpacity, TextInput, ScrollView, ActivityIndicator, KeyboardAvoidingView } from 'react-native'
...
const Collections = () => {
    ...
    const searchStock = async (value) => {
        ...
        try {
            await axios.get(`${searchUrl}${value}`)
                .then((res) => {
                    ...
                    <ScrollView style={styles.ScrollView}>
                        <View style={styles.SelectedStockWrap}>
                            ...
                            <View style={styles.NameDescCont}>
                                ...
                                <Text style={styles.TextNameDescValue}>{selectedStock.Custname}</Text>
                            </View>
                            <View style={styles.NameDescCont}>
