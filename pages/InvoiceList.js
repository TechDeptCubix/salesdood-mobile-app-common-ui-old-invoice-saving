...
const InvoiceList = () => {
    ...
    const getTRNnumber = (companyCodeToCheck) => {
        ...
        switch (companyCodeToCheck) {
            ...
            case "MESHARI" : return "100449215100003"
            default: return "-"
        }
    ...
    const getCompanyname = (companyCodeToCheck) => {
        ...
        switch (companyCodeToCheck) {
            case "PREMIER": return "PREMIER AUTO PARTS LLC";
            case "MESHARI" : return "MESHARI FOODSTUFF TRADING LLC";
            case "ICELAB" : return "THE ICE LAB MANUFACTURING LLC"
            default: return "-"
        }
        ...
        <head>
            ...
            <body>
                ...
                <div class="InvCard">
                        ...
                        `<div class=${cmpcode?.trim().toLowerCase() == 'premier' ? "header_without_top_margin" : ""}>
                              
                         </div>`
                        : ""}
                
                <div class=${cmpcode?.trim().toLowerCase() == 'icelab' || cmpcode?.trim().toLowerCase() == 'icelab_test' ? "header_zero_margin_top" : ""}>
        ...
        <div class="totals-section">
                    ...
                    <div style="display:flex;width:100%;margin-top:10px">
                            ...
                            <div style="display:flex;justify-content:end;width:40%;">
                                ...
                                <div style="font-weight: bold;padding-left:50px;padding-top:5px"><label style="font-weight: bold;"> ${getCompanyname(cmpcode?.trim().toUpperCase())}</label></div>
                                </label>
                            </div>
                        </div>  
        </div>
